    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><b>Service</b>Center</span>
        </a>
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="img/logo_di3.png" class="user-image" alt="User Image">
                  <span class="hidden-xs">Mahasiswa</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="img/logo_di3.png" class="img-circle" alt="User Image">
                    <p>
                      Mahasiswa Unnur - Web Developer
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="general.html"><i class="fa fa-circle-o"></i> Input Data Service</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
                <i class="fa fa-table"></i> <span>Tables Service</span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li><a href="tampil_data.php"><i class="fa fa-circle-o"></i> Data tables</a></li>
              </ul>
            </li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            General Form
            <small>PT Dirgantara Indonesia</small>
          </h1>
          <ol class="breadcrumb">
          ...
          <div class="row">
            ...
            <div class="col-md-8">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" method="post" action="crud_servis.php">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="exampleInputNamaUser">Nama User</label>
                      <input type="text" name="nama_user" class="form-control" id="exampleInputEmail1" placeholder="Masukan nama user">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputNIK">NIK</label>
                      <input type="text" name="nik_user" class="form-control" id="exampleInputPassword1" placeholder="180096">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputNoAset">No Aset</label>
                      <input type="text" name="no_aset" class="form-control" id="exampleInputPassword1" placeholder="1270000xxx">
                    </div>
                    <div class="form-group">
                      <label for="examplePilihKategori">Kategori</label>
