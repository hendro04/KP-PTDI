          ...
          <li class="header">MAIN NAVIGATION</li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="input_servis.php"><i class="fa fa-circle-o"></i>Input Data Service</a></li>
              </ul>
            </li>
            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Tampilan Data Hasil Input</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
    ...
    <tr>
     <td><?php echo $no++;?></td>
        ...
        <?php
            if($d['status'] == 1){
                echo 'Dalam Antrian';
                ?> <br> <a class="btn btn-flat btn-sm bg-green" href="update_status.php?s=2&t=<?php echo $d['no_token'] ?>">Proses</a> <?php
            } else if($d['status'] == 2){
