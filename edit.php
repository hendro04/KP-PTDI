      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <div class="row">
            ...
            ?>
                <form role="form" method="post" action="edit_proses.php">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="exampleInputNamaUser">Nama User</label>
                      <input type="text" name="no_token" value="<?php echo $d['no_token']?>" hidden>
                      <input type="text" name="nama_user" class="form-control" id="exampleInputEmail1" placeholder="Masukan nama user" value="<?php echo $d['nama_user']?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="no_aset" class="form-control" id="exampleInputPassword1" placeholder="1270000xxx" value="<?php echo $d['no_aset']?>">
                    </div>
                    <div class="form-group">
